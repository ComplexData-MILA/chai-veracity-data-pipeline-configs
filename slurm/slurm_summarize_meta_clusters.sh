#!/bin/bash
#SBATCH --job-name=cdl-summarize-meta
#SBATCH --output=logs/summarize_meta_%j.out
#SBATCH --error=logs/summarize_meta_%j.err
...
DATASET_NAME="${DATASET_NAME:-posts_double_summarized_001}"
INPUT_DATASET="${INPUT_DATASET:-posts_clustered_meta_001}"
TEMPLATE="${TEMPLATE:-templates/summarize_claims_cluster.txt}"
